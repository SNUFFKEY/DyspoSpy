...
from src.carLookup import carSearch
from src.pastebinLookup import pasteBinSearch
from src.fileLookup import fileSearch
from src.codeLookup import codeSearch
from src.imageLookup import imageSearch
...
# USERNAME LOOKUP FILE FORMAT
        ...
        operation = "--user"
        if fileType == "--html":
            username_lookup("html",fileNameParam=fileName,usernameToLookup)

        elif fileType == "--pdf":
            username_lookup("pdf",fileNameParam=fileName,usernameToLookup)
            
        elif fileType == "--txt":
            username_lookup("txt",fileNameParam=fileName,usernameToLookup)
...
# HELP LOOKUP STUFF
        ...
        if sys.argv[i] == "--help" and sys.argv[1] != "--help":
            print("Please Use python3 main.py --help")
