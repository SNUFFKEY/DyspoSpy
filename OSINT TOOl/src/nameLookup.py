...
def name_lookup(format,fileNameParam):
    ...
    if prompt.upper() == "Y":
        if usrstate.lower() in abbreviations:
            ...
            if middlename == "":
                link = f"https://www.smartbackgroundchecks.com/people/{firstname}-{lastname}/{city}/{state_abbr}"
    ...
    smartbackgroundCheck()

    def fastpeopleSearch():

        
        if middlename == "":
            fastpeopleSearch = f"https://www.fastbackgroundcheck.com/people/{firstname}-{lastname}/{city}-{usrstate}"
            webbrowser.open(fastpeopleSearch)

        elif middlename != "":

            fastpeopleSearch = f"https://www.fastbackgroundcheck.com/people/{firstname}-{middlename}-{lastname}/{city}-{usrstate}"
            webbrowser.open(fastpeopleSearch)
    else:
